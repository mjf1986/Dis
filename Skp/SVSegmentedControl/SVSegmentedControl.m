...
- (id)initWithSectionTitles:(NSArray*)array {
	...
	if (self = [super initWithFrame:CGRectZero]) {
        ...
        self.backgroundTintColor = [UIColor colorWithWhite:0 alpha:0.2];//[UIColor colorWithWhite:0 alpha:0.5];
        ...
        self.textColor = [UIColor whiteColor];//[UIColor grayColor];
...
- (BOOL)continueTrackingWithTouch:(UITouch *)touch withEvent:(UIEvent *)event {
    ...
    NSLog(@"continueTrackingWithTouch:%s",__TIME__);
