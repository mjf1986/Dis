...
{
    tableHeaderHeight = fHeight;
    ScalableCover *cover = [[ScalableCover alloc] initWithFrame:CGRectMake(0, 0, self.bounds.size.width, tableHeaderHeight)];
...
- (void)layoutSubviews
{
    ...
    if (self.scrollView.contentOffset.y < 0) {
        ...
        self.frame = CGRectMake(-offset, -offset, _scrollView.bounds.size.width + offset * 2, tableHeaderHeight + offset);
    } else {
        self.frame = CGRectMake(0, 0, _scrollView.bounds.size.width, tableHeaderHeight);
    }
}
